...
class OhcannabisstoreScraper(BaseSpider):
	name = 'ohcannabisstore'
	start_urls = ['https://shop.ohcannabisstore.com/ht/api/objects/kiosk/stores']
	p_id = '771309431'
	shop_name = 'Oh Cannabis'
	...
	def parse(self, response):
		...
		yield {
			...
			"Description": "",
			"Link": "https://shop.ohcannabisstore.com/clickncollect/",
			"SKU": "",
			"City": store["city"],
			...
			"lat": "",
			"ccc": "",
			"Page Url": "https://shop.ohcannabisstore.com/clickncollect/",
			"Active": "",
			"Main image": f'https://shop.ohcannabisstore.com/s/{store["logo"]}',
			"Image 2": '',
			"Image 3": '',
			"Image 4": '',
			"Image 5": '',
		...
		yield scrapy.Request('https://shop.ohcannabisstore.com/ht/api/objects/kiosk/products?page_size=2000&page=0', headers=headers, callback=self.parse_products)
	...
	def parse_products(self, response):
		...
		for product in products:
			...
			if img:
				img = f'https://shop.ohcannabisstore.com{img}'
			...
			if product["on_hand"]:
				...
				if cnt > 0:
					stock = 'In Stock'
			yield {
				"Page URL": f'https://shop.ohcannabisstore.com/clickncollect/shop-cannabis-online/344_wilson_ave./{product["id"]}',
				"Brand": brand,
