...
class HappyDayzSpider(BaseSpider):
    name = 'happydayz'
    shops = {
		'241049': 'https://happy-dayz.ca/stores/ON/peterborough-george-street',
        '241047': 'https://happy-dayz.ca/stores/ON/orillia-mississauga-st-e',
        '241048': 'https://happy-dayz.ca/stores/ON/oshawa-bond-st',
        '241044': 'https://happy-dayz.ca/stores/ON/midland-midland-ave',
        '241043': 'https://happy-dayz.ca/stores/ON/barrie-dunlop-st',
        '241046': 'https://happy-dayz.ca/stores/ON/newmarket-davis-drive',
	}
    shop_name = 'Happy Dayz'
    img = 'https://ca.cdn.hifyreretail.com/130007/20210602/e20fe240ae204792b33e9349881c1b8e'
    email = 'info@happy-dayz.ca'

    def start_requests(self):
        for shop_pid in self.shops:
            print(shop_pid)
            url = f'https://happy-dayz.ca/shop/{shop_pid}?redirect=%2Fshop'
            res = r.get(url)
            cookies = ''
    ...
    def parse_store(self, response):
        ...
        page = 1
        base_link = f'https://happy-dayz.ca/shop?q={brands}'
    ...
    def parse_menu(self, response):
        ...
        for product_id in product_ids:
        	yield scrapy.Request(f'https://happy-dayz.ca/products/{product_id}', dont_filter=True, callback=self.parse_product, meta={'p_id': p_id, 'product_id': product_id, 'cookies': cookies}, headers={'cookie': cookies})
        if product_ids:
