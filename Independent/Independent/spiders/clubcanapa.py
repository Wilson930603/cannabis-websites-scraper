...
class BorderlandScraper(BaseSpider):
	name = 'clubcanapa'
	shop_name = 'Club Canapa Cannabis'
	p_id = '248466'
	start_urls = ['https://clubcanapa.budguide.io/#/main']
	...
	def parse(self, response):
		...
		yield {
			...
			"Description": "",
			"Link": 'https://clubcanapa.budguide.io/#/main',
			"SKU": "",
			"City": city,
			"Province": 'ON',
			...
			"lat": '',
			"ccc": "",
			"Page Url": 'https://clubcanapa.budguide.io/#/main',
			"Active": "",
			"Main image": '',
			"Image 2": "",
			"Image 3": "",
		...
		ws.recv()
		ws.send('{"t":"d","d":{"r":2,"a":"q","b":{"p":"/iqmetrix/mergedList/ids/ClubCanapaCannabis-dot-Budvue/248466/6bb2ecfa4bd785c09b7d22cc8ff3253b","h":""}}}')
		result = ws.recv()
		ws.recv()
		...
		for id_obj in ids:
			obj_oid = ids[id_obj]
			nb += 1
			msg_send = '{{"t":"d","d":{{"r":{},"a":"q","b":{{"p":"/iqmetrix/mergedList/products/ClubCanapaCannabis-dot-Budvue/248466/6bb2ecfa4bd785c09b7d22cc8ff3253b/{}","h":""}}}}}}'.format(nb, obj_oid)
			ws.send(msg_send)
			res = ws.recv()
			ws.recv()
