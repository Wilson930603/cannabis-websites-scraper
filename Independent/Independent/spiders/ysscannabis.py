...
class YssCannabisSpider(BaseSpider):
	name = 'ysscannabis'
	start_urls = ['https://ysscannabis.com/ht/api/objects/kiosk/stores']
	shop_name = 'Sweet Tree Cannabis Co.'
	p_id = '126581001'
	...
	def parse(self, response):
		...
		yield {
			...
			"lat": "",
			"ccc": "",
			"Page Url": "https://ysscannabis.com/",
			"Active": "",
			"Main image": f'https://ysscannabis.com/s/{store["logo"]}',
			"Image 2": '',
			"Image 3": '',
			"Image 4": '',
			"Image 5": '',
		...
		yield scrapy.Request('https://ysscannabis.com/ht/api/objects/kiosk/products?on_hand=true&cannabis=true&is_active=true&page_size=20000&page=0&onsale=0&favorites=0&newproducts=0&featured=0', headers=headers, callback=self.parse_products)
	...
	def parse_products(self, response):
		...
		for product in products:
			...
			if img:
				img = f'https://ysscannabis.com{img}'
			...
			if product["on_hand"]:
				...
				if cnt > 0:
					stock = 'In Stock'
			yield {
				"Page URL": f'https://ysscannabis.com/clickncollect/shop-cannabis-online/unit_2,_212_central_ave_north/{product["id"]}',
				"Brand": brand,
