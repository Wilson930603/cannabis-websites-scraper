...
class CSVPipeline:
    def open_spider(self, spider):
        self.p_ids = set()
        self.producer_id = 0
        file_path_producer = f'{spider.settings.get("DATA_FILE_PATH")}/Producer_{spider.city}.csv'
        ...
        file_path_products = f'{spider.settings.get("DATA_FILE_PATH")}/Products_{spider.city}.csv'
